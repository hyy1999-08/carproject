...
class Surface(ttk.Frame):
	...
	def __init__(self, win):
		...
		self.predictor = mypredict.CardPredictor()
	...
	def get_imgtk(self, img_bgr):
		...
		if wide > 600 or high > 600:
			wide_factor = 600 / wide
			high_factor = 600 / high
	...
	def from_pic(self,url):#okkkkkkkkkkkkkk
		pic_path = url;	#路径
		if pic_path:
			img_bgr = mypredict.imreadex(pic_path)
			predictor = mypredict.CardPredictor()
			r, roi, color =predictor.predict(img_bgr)
			return r
